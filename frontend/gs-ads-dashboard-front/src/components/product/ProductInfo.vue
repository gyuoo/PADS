<template>
    <div class="bg-white rounded-3xl shadow-lg p-10 w-full h-full text-center space-y-4">
        <img 
    :src="imageUrl" 
    alt="상품 이미지" 
...
/>
        ...
        <div class="text-right font-semibold">
            <div class="text-base text-right text-gray-500 font-normal">
                {{ productData.cate1Nm }} > {{ productData.cate2Nm }} > {{ productData.cate3Nm == '0' ?  '': productData.cate3Nm }}
            </div>
            <div class="text-3xl">
        ...
        <table class="w-full border border-gray-200 text-left text-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 border-b">{{ productData.cate3Nm == '0' ?  '-': productData.cate3Nm }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 border-b">{{ productData.discPrice.toLocaleString() }} 원</td>
                </tr>
                <tr>
